package com.divyanshu.opusplayer.opus;
 ...
 */
public class OpusLocalService extends Service {


        private String TAG = top.oply.opuslib.OpusService.class.getName();
        ...
        public static void play(Context context, String fileName) {
            Intent intent = new Intent(context, top.oply.opuslib.OpusService.class);
